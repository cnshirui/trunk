...
/**
* Represents the parser state, only used when parsing/lexing
* @version 1.0
* @author Lem Hongjian
*/
public class ParserState{
	public static final int EXPR_BEGIN = 0;
	public static final int EXPR_END = 1;
	
	public static int state = ParserState.EXPR_BEGIN;
