...
class JoinWatcherAnsMsg extends Msg
{
	/**
	 * 
	 */
	private static final long serialVersionUID = 1L;
	private Chessboard.ChessboardState state;
	public JoinWatcherAnsMsg(Chessboard.ChessboardState state)
	{
		super(Msg.MsgType.JOIN_WATCHER_ANS_MSG);
		this.state=state;
	}
	public Chessboard.ChessboardState getChessboardState()
	{
		return this.state;
	}
}
